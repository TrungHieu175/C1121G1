        ...
        <div class="col-9">
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="customer_code" name="product_name" value="${product.productName}">
                </div>

                <div class="form-group">
                    <label for="customer_name">Price</label>
                    <input type="text" class="form-control" id="customer_name" name="product_price" value="${product.productPrice}">
                </div>

                <div class="form-group">
                    <label for="customer_birthday">Quality</label>
                    <input type="text" class="form-control" id="customer_birthday" name="product_quantity" value="${product.productQuantity}">
                </div>
                <div class="form-group">
                    <label for="customer_gender">Color</label>
                    <input class="form-control" id="customer_gender" name="product_color" value="${product.productColor}">
                </div>
                <div class="form-group">
